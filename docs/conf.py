...
latex_documents = [
    (master_doc, 'gbm_drm_gen.tex', u'gbm_drm_gen Documentation',
...
man_pages = [(master_doc, 'gbm_drm_gen', u'gbm_drm_gen Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'gbm_drm_gen', u'gbm_drm_gen Documentation', author, 'gbm_drm_gen',
