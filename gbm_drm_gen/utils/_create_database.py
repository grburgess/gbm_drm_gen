...
for det in dets:
    ...
    grp.create_dataset('double_phi_cent', data=dd.double_phi_cent,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('e_in', data=dd.e_in,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('energ_hi', data=dd.energ_hi,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('energ_lo', data=dd.energ_lo,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('epx_hi', data=dd.epx_hi,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('epx_lo', data=dd.epx_lo,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('ichan', data=dd.ichan,
                       # compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('ienerg', data=dd.ienerg,
                       # compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('lat_cent', data=dd.lat_cent,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('lat_edge', data=dd.lat_edge,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
    grp.create_dataset('LEND', data=dd.LEND,
                       compression='lzf'
                       # compression_opts=(block_size, bitshuffle.h5.H5_COMPRESS_LZ4
                       )
